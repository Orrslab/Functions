...
#'   - \code{config$paths$random_forest_results_folder}: Folder path where model and datasets are stored.
...
#' metrics tables, and maps, are saved in the specified \code{random_forest_results_folder}.
#'
#' @examples
#' \dontrun{
#' config <- list(
