...
# Flying Barn Owls
# path_to_db <- "C:/Users/netat/Documents/Movement_Ecology/Filter_development/Stops_Filter/Stops_DB/Flying_Barn_Owls"
# Moving Barn Owl
...
metadata_per_tag <- generate_metadata_per_tag_from_species_localization_data(
  species_localization_data,
