...
#' Create a file name from Animal's Code or Name, Tag Numbers and Date Range
#'
#' This function generates a file name without extension based on the 
#' provided animal's name, tag numbers and date range. If a single tag number is provided, 
...
#'                 The function will replace spaces with underscores and colons with hyphens.
#'
#' @return A string representing the file name without extension, 
...
#' @export
#' 
create_filename_without_extension <- function(animal_name_code, tag_numbers, start_time, end_time) {
  ...
  filename_without_extension <- paste(animal_name_code, "_",
