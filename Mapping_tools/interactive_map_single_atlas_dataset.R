...
#'
interactive_map_single_atlas_dataset <- function(dd,
                                                 color_dd = "red",
                                                 MapProvider='Esri.WorldImagery', 
                                                 legendLabels=c("1")) # 'OpenStreetMap.BZH'
{
...
# # Usage example
# map <- interactive_map_single_atlas_dataset(dd = your_atlas_data,
#                                             legendLabels = c("ATLAS data"))
# print(map)